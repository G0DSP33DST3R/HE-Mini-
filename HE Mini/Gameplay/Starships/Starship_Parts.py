...
class BattleCruiser_Core(StarshipPart):
    ...
    stats = {"Fuel": "Hydrogen"}
# Probes
class ProbeLauncher(Civilian_Hardpoint):
    name = "Probe Launcher"
    description = "A Launcher Made for launching Scanning Probes"
    cost = 200
    mass = 35
    compatible_classes = ["shuttle", "transport", "light_freighter", "blockade_runner", "medium_freighter", "heavy_freighter"]
    stats = {"CanFire": "Scanner Probe"}

class AdvancedProbeLauncher(Military_Hardpoint):
    name = "Advanced Probe Launcher"
    description = "A modified version of the Probe Launcher, Invented by the Verucians."
    cost = 430
    mass = 55
    compatible_classes = ["barge", "scrambler", "recon", "stasis_corvette", "missile_cruiser", "industrial_command_ship"]
    stats = {"CanFire": "Scanner Probe", "CanFire": "Combat Probe"}
# MiningLasers
class MiningLaserT1(Civilian_Hardpoint, Military_Hardpoint):
    name = "Mining laser Tier i"
    description = "The first iteration of the mining laser."
    cost = 300
    mass = 15
    parttype = "Mining laser"
    compatible_classes = ["shuttle", "transport", "light_freighter", "medium_freighter", "heavy_freighter", "barge", "industrial_command_ship", "corvette", "frigate", "destroyer", "cruiser", "battlecruiser"]
    stats = {"RateOfFire": 52}

class MiningLaserT2(Civilian_Hardpoint):
    name = "Mining laser Tier ii"
    description = "An improved model of the first laser"
    cost = 415
    mass = 85
    parttype = "Mining laser"
    compatible_classes = ["Transport", "light_freighter", "medium_freighter", "heavy_freighter", "barge", "industrial_command_ship"]
    stats = {"RateOfFire": 60}

class MiningLaserT3(Civilian_Hardpoint):
    name = "Mining laser Tier iii"
    description = "A model of laser used heavily in industry"
    cost = 1250
    mass = 220
    parttype = "Mining laser"
    compatible_classes = ["light_freighter", "medium_freighter", "heavy_freighter", "barge", "industrial_command_ship"]
    stats = {"RateOfFire": 68}

class MiningLaserT4(Civilian_Hardpoint):
    name = "Mining laser Tier iv"
    description = "A laser built heavily dependent on the power production of a SubReactor Core"
    cost = 2540
    mass = 625
    parttype = "Mining laser"
    compatible_classes = ["barge", "industrial_command_ship"]
    stats = {"RateOfFire": 76}
